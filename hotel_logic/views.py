...
async def get_all_room_information(room_info_id: int,
                                   db: AsyncSession = Depends(get_db),
...
# =========================== ROOM VIEWS ==========================
@router.post("rooms/create/", response_model=RoomInformationResponse, status_code=status.HTTP_201_CREATED)
